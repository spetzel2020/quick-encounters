...
14-Sep-2021     0.8.5a: Reintroduce deletion of notes; doesn't seem to be handled in Foundry 0.8.9
*/
...
export class EncounterNote {
    ...
    static async delete(journalEntry) {
        ...
        for (const scene of game.scenes) {
            ...
            //v0.8.5a: Reintroduce deleltion of notes; doesn't seem to be handled in Foundry 0.8.9
