...
1. Select one friendly token and press QE button -> should ask if you want to add to JE			            	0.7.1
2. Select multiple friendly and neutral tokens -> should ask...						                0.7.1
3. Select one hostile token and press QE button -> adds to JE						                0.7.1
4. Select multiple hostile and neutral tokens and press QE button -> adds to JE 				            	0.7.1

### METHOD 2 - add tokens to blank JE
1. Add Actors to a Journal Entry ; should re-render with QE dialog 				                                0.7.1         	

### METHOD 3 - add tokens to existing
1. Open an existing QE with 1xActor; select 3 of the same tokens - should increase the number to 4			0.7.1

### NEW FEATURES IN 0.6 - merge into above
0. Open QE with QE Dialog and Run                                                                               				0.7.1
1. Open a vanilla Journal Entry, select tokens, and press the QE button to turn this into a QE -> ADD vs. CREATE dialog	0.7.1
...
### MAP NOTES
1. Delete Note; should warn there is no Note when you open the Journal Entry 				                0.7.1
2. Move Note - Generated Actor tokens should be created at the position of the Note			                            	0.7.1
3. Start on another Scene and run an Encounter - should switch scenes     					                0.7.1
...
7. Launch from the Journal Entry - should find a random Note or prompt to create one                            			0.7.1
8. Delete the QE Journal Entry - should delete all the related Notes						 0.7.1

## v0.7.1
1. Hover over Token in QE dialog and remove								0.7.1
2. Hover over Tile in QE dialog and remove								0.7.1								
...
### TUTORIAL
1. Press Quick Encounter button with nothing selected -> should pop up Tutorial					0.7.1 			             		
2. With Tutorial open, repeat #1 -> should keep existing Tutorial         						0.7.1        	                        	
3. Close Tutorial -> should delete the Journal Entry                          						0.7.1      					    	
